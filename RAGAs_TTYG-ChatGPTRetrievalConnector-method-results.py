...
''',
    ...
    'No, it is not true that the merchant cancels the invoice right after issuing it. According to the process, the task that follows "Issue invoice" is "Pack order," not "Cancel invoice."',
